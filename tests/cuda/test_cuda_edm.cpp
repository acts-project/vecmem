...
/// Test fixture for the CUDA EDM tests
class cuda_edm_test : public testing::Test {
...
protected:
    ...
    vecmem::cuda::managed_memory_resource m_managed_mr;
...
TEST_F(cuda_edm_test, modify_device) {
...
TEST_F(cuda_edm_test, fill_device) {
